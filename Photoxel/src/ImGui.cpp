...
namespace Photoxel
{
	ImGuiLayer::ImGuiLayer(std::shared_ptr<Window>& window)
		: m_Window(window)
	{
		IMGUI_CHECKVERSION();
		ImGui::CreateContext();
		...
		ImGui_ImplGlfw_InitForOpenGL((GLFWwindow*)m_Window->GetNativeHandler(), true);
	...
	{
		bool opt_fullscreen = m_OptFullscreenPersistant;
